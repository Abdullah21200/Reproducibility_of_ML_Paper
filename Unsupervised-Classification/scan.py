...
def main():
    ...
    p = create_config(args.config_env, args.config_exp, args.num_clusters)
    print(colored(p, 'red'))
    ...
    features_path = os.path.join(savedir, f'features_clusters{args.num_clusters}.npy')
    probs_path = os.path.join(savedir, f'probs_clusters{args.num_clusters}.npy')
